...
public class RedissonList<V> extends RedissonExpirable implements RList<V> {
    ...
    public int addListener(ObjectListener listener) {
        ...
        if (listener instanceof QueueRemoveListener) {
            return addListener("__keyevent@*:lpop", (QueueRemoveListener) listener, QueueRemoveListener::onQueueRemove);
        }
    ...
    public RFuture<Integer> addListenerAsync(ObjectListener listener) {
        ...
        if (listener instanceof QueueRemoveListener) {
            return addListenerAsync("__keyevent@*:lpop", (QueueRemoveListener) listener, QueueRemoveListener::onQueueRemove);
        }
    ...
    public void removeListener(int listenerId) {
        ...
        RPatternTopic lpopTopic = new RedissonPatternTopic(StringCodec.INSTANCE, commandExecutor, "__keyevent@*:lpop");
        lpopTopic.removeListener(listenerId);
    ...
    public RFuture<Void> removeListenerAsync(int listenerId) {
        ...
        RPatternTopic lpopTopic = new RedissonPatternTopic(StringCodec.INSTANCE, commandExecutor, "__keyevent@*:lpop");
        RFuture<Void> f6 = lpopTopic.removeListenerAsync(listenerId);
        
        RFuture<Void> f7 = super.removeListenerAsync(listenerId);
        
        CompletableFuture<Void> f = CompletableFuture.allOf(f1.toCompletableFuture(), f2.toCompletableFuture(), f3.toCompletableFuture(),
                f4.toCompletableFuture(), f5.toCompletableFuture(), f5.toCompletableFuture(), f6.toCompletableFuture(), f7.toCompletableFuture());
        return new CompletableFutureWrapper<>(f);
    }
